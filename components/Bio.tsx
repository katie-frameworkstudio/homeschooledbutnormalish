      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-8 md:space-y-0">
          ...
          <div className="md:grid md:grid-cols-5 md:gap-12 md:items-start">
            ...
            <div className="relative w-full max-w-sm mx-auto md:mx-0 mb-8 md:mb-0 md:col-span-2">
              <div className="relative">
                ...
                <div className="absolute -top-6 -left-6 w-32 h-32 bg-hunter-500/20 rounded-full blur-2xl"></div>
                <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-hunter-500/15 rounded-full blur-2xl"></div>

                {/* Image container with border */}
                <div className="relative bg-gradient-to-br from-hunter-600 to-hunter-800 p-1.5 rounded-2xl shadow-xl">
                ...
                <div className="absolute -bottom-4 -right-4 w-16 h-16 border-4 border-hunter-600 rounded-full"></div>
              </div>
            </div>
            ...
            <div className="hidden md:block md:col-span-3 space-y-4 text-base text-gray-700 leading-relaxed">
              ...
              <div className="my-6 py-6 px-6 bg-gradient-to-br from-hunter-50 to-warm-50 border-l-4 border-hunter-600 rounded-r-xl shadow-sm">
          ...
          <div className="md:hidden max-w-2xl mx-auto">
            <div className="py-6 px-6 bg-gradient-to-br from-hunter-50 to-warm-50 border-l-4 border-hunter-600 rounded-r-xl shadow-sm">
              <p className="font-display text-2xl sm:text-3xl text-sage-900 italic leading-tight">
                &ldquo;Normal but far from average&rdquo;
              </p>
              <p className="text-sm text-sage-600 mt-2">
