export const siteContent = {
  meta: {
    title: "Homeschooled but Normal...ish | Michael Ramey",
    description:
      "I'm Michael Ramey and I was homeschooled K-12. I've lived the results and wrote about the pros because, honestly, there are no cons.",
    url: "https://homeschooledbutnormalish.com",
  ...
  hero: {
    ...
    title: "Homeschooled but Normal...ish",
    subtitle: "I'm Michael Ramey and I was homeschooled K-12.",
    supportingText:
      "I've lived the results and wrote about the pros because, honestly, there are no cons.",
    headshot: "/images/michael-headshot.jpg",
    headshotAlt: "Michael Ramey",
    authorName: "Michael Ramey",
  },
  ...
  bio: {
    ...
    content: [
      ...
      "Now back in St. Louis, I run an in-home healthcare company, serving those in need while continuing to feed my creative heart as an author.",
      "Far from sheltered, I've traveled the world, created, and impacted lives, and I'm thrilled for where my normal…ish journey leads next.",
      "Connect with me to share the adventure!",
    ],
  },
  ...
  speaking: {
    ...
    headline:
      "I didn't have a homeschooled grad to look up to so... I became one. Now I speak to homeschool groups about confidence, socialization, and life after graduation.",
    images: [
      {
        src: "/images/speaking-1.jpg",
        alt: "Speaking engagement 1",
      },
      {
    ...
    statement: [
      "I've been an actor, toured the country on stage, worked in TV and film as a writer, director, and producer, and now run my own healthcare company. But none of that would've been possible without homeschooling. It gave me the confidence to lead, the space to explore, and the mindset to build the life I wanted.",
      "Now, I'm here to show other homeschoolers what's possible.",
      "I'm excited to talk about life beyond homeschooling.",
      "Because the best part is what comes next.",
    ],
  },
